...
export const CTASection: React.FC<CTASectionProps> = ({
  ...
  const displayTitle = title || t.home.ctaSection.title;
  const displaySubtitle = subtitle || t.home.ctaSection.subtitle;
  const displayPrimaryBtn = primaryButtonText || t.home.ctaSection.primaryButton;
  const displaySecondaryBtn = secondaryButtonText || t.home.ctaSection.secondaryButton;
    ...
    <section className="py-16 bg-[#DC2626] text-white relative overflow-hidden">
      ...
      <div className="container-custom relative z-10 text-center max-w-3xl mx-auto">
        ...
        <div className="mt-8 pt-8 border-t border-red-200/60 flex flex-wrap items-center justify-center gap-6 text-xs text-red-600">
          <span>{t.home.ctaSection.urgentPrompt}</span>
          <a
          ...
          >
            ...
            <span>{t.home.ctaSection.callTollFree} {companyConfig.phoneDisplay}</span>
          </a>
        </div>
      </div>
    </section>
